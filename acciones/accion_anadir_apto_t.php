<?php
    ...
    if(isset($_REQUEST['id'])){
        ...
        if(isset($error)){
            $error['donde'] = "<strong>Los errores han ocurrido en el formulario para añadir la nota de un examen teórico</strong>";
            $_SESSION['error'] = $error;
            header("Location: ../lista_alumnos.php");
        } else {
            resultadoExamenTeorico($conexion, $_REQUEST['id_ex'], $_REQUEST['id'], $_REQUEST['apto']);

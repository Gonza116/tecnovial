<?php
    ...
    if(trim($_REQUEST['nuevoProfesor_apellidos'], " ") == ""){
        $error['nombre'] = "Los apellidos del profesor no puede estar vacío";
    }

    if(trim($_REQUEST['nuevoProfesor_pass'], " ") == ""){
        $error['nombre'] = "La pass del profesor no puede estar vacío";
    }

    if(trim($_REQUEST['nuevoProfesor_passrep'], " ") == ""){
        $error['nombre'] = "La repeticoin de pass del profesor no puede estar vacío";
    }
